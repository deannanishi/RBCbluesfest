...
$(function(){
	...
	if(viewOpts.logo){
		...
		$logoImg.load(function(e) { $vlogo.width($logoImg.width()); });
	} else { $vlogo.hide(); }
...
function zoom(dir){
	var flipTarg = $('.activePage .page-scale-wrap'), $body = $('body'),
	...
	switch(dir){
		case 'in':
			...
			var maxScale = 10;
			currentScale = parseFloat(getCurrentScale(scaleTarg[0],true));
	...
	if(removeZoomClass) $body.removeClass('zoomed');
}
